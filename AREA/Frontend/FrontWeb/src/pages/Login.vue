  ...
  <div class="login-page">
    <div class="login-section">
      <div class="form-container">
        ...
        <input v-model="user" placeholder="Email" class="input-field" />
        <input v-model="pass" placeholder="Password" type="password" class="input-field" />
        <div class="button-login">
        <v-btn block variant="tonal" @click="created(user, pass)">Sign in</v-btn>
        </div>
        <div class="center_text">
          <router-link to="/create-account" class="create-account">Create an account</router-link>
        </div>
